				...
				<div class="relative flex items-end justify-start overflow-hidden rounded-lg bg-gray-300 p-10 sm:mr-10 md:w-1/2 lg:w-2/3">
					...
					<div class="relative flex flex-wrap rounded bg-white py-6 shadow-md">
						...
						<div class="mt-4 px-6 lg:mt-0 lg:w-1/2">
							...
							<address class="leading-relaxed text-accent">example@email.com</address>
				...
				<div class="mt-8 flex w-full flex-col bg-white md:ml-auto md:mt-0 md:w-1/2 md:py-8 lg:w-1/3">
					...
					<div class="relative mb-4">
						...
						<input
							...
							id="name"
							name="name"
							class="w-full rounded border border-gray-300 bg-white py-1 px-3 text-base leading-8 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-accent"
						/>
					</div>
					<div class="relative mb-4">
					...
					<div class="relative mb-4">
						...
						<textarea
							id="message"
							name="message"
							class="h-32 w-full resize-none rounded border border-gray-300 bg-white py-1 px-3 text-base leading-6 text-gray-700 outline-none transition-colors duration-200 ease-in-out focus:border-accent"></textarea>
					</div>
					<button class="rounded border-0 bg-accent py-2 px-6 text-lg text-white hover:bg-red-500 focus:outline-none">
						Send Feedback
					</button>
